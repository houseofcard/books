...
class Product{
	...
	function readAll($from_record_num, $records_per_page){
		...
		$query = "SELECT
					c.name as category_name, p.id, p.name, p.author, p.description, p.category_id, p.active_until
				FROM
					" . $this->table_name . " p
					LEFT JOIN
						categories c
	...
	function readOne(){
		...
		$query = "SELECT
					c.name as category_name, p.name, p.author, p.description, p.category_id, p.active_until
				FROM
					" . $this->table_name . " p
					LEFT JOIN
						categories c
